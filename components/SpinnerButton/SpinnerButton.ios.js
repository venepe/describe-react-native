...
import { ActivityIndicatorIOS, StyleSheet, Text, TouchableHighlight, View } from 'react-native';
...
class SpinnerButton extends Component {
  ...
  render() {
    let btn = (this.state.showSpinner) ? (<ActivityIndicatorIOS animating={true} style={styles.spinner} size='small' />) : null;
    return (
