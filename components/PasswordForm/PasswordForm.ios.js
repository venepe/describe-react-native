  ...
  render() {
    ...
    return (
      <View style={{flex: 1, backgroundColor: '#FFFFFF'}}>
        <NavigationBar title={{title: 'Change Password', tintColor: '#373e4d'}} leftButton={<BackNavigationButton side={'left'} onPress={this._closeModal}/>} rightButton={<CheckNavigationButton isDisabled={this.state.isLoading || !(this.state.isNewPasswordValid && this.state.isCurrentPasswordValid)} onPress={this._onSubmit}/>} />
